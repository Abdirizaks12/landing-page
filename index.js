          ...
          <ul class="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium">
            ...
            <li>
              ...
              <div id="dropdownNavbar" class="hidden bg-white text-base z-10 list-none divide-y divide-gray-100 rounded shadow my-4 w-44">
                  ...
                  <li>
                      <a href="#" class="text-sm hover:bg-gray-100 text-gray-700 block px-4 py-2">Features</a>
                  </li>
                  <li>
                      <img src="./public/images/"/>
                      <a href="#" class="text-sm hover:bg-gray-100 text-gray-700 block px-4 py-2">Todo List</a>
                  </li>
                  <li>
              ...
              <li>
                  ...
                  <div id="dropdownNavbar" class="hidden bg-white text-base z-10 list-none divide-y divide-gray-100 rounded shadow my-4 w-44">
                      <ul class="py-1" aria-labelledby="dropdownLargeButton">
                      <li>
                          <a href="#" class="text-sm hover:bg-gray-100 text-gray-700 block px-4 py-2">Company</a>
                      </li>
                      <li>
